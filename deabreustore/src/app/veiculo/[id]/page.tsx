...
export default function VehicleDetails() {
    ...
    return (
        <>
            ...
            <Box pt={5} sx={{ backgroundColor: "#212121" }}>
                {vehicle && (
                    <Box paddingX={10}>
                        <Box>
                            <Box sx={{
                            ...
                            <Typography fontWeight={"bold"} color={"#fff"} variant="h6">{vehicle.brand}</Typography>
                            <Box sx={{
                                width: "20vw",
                                height: "3px",
                                backgroundColor: "#e0c000",
                        ...
                        <Grid container spacing={2} mt={2}>
                            <Grid size={{ xs: 12, sm: 6, md: 7 }}>
                                <Box sx={{ width: "100%", height: "100%" }}>
                                    <img
                                        src={`http://localhost:8000/storage/${vehicle.images[0]}`}
                                        alt={vehicle.name}
                                        width="100%"
                                        height="100%"
